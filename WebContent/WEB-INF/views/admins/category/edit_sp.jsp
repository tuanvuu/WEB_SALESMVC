				...
				<div class="container-fluid">
					...
					<div class="container">
						<div class="container_input">
							<h2 style="color: blue;">Chỉnh sửa loại sản phẩm</h2>
							<h2 style="color: red;">${message}</h2>
							<c:choose>
								<c:when test="${userAdmin != null}">
									<form:form action="admins/category/edit/${cateId}.htm"
										modelAttribute="editCategory" method="post">

										<form:hidden path="cateId" />
										<div class="form-group">
											<label for="usr">ID</label>
											<form:input cssClass="form-control" path="cateId"
												readonly="true" />
										</div>
										<div class="form-group">
