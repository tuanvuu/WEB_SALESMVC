						...
						<div class="container_input">
							...
							<c:choose>
								<c:when test="${userAdmin != null}">
									<form:form action="admins/product/insert.htm"
										enctype="multipart/form-data" modelAttribute="insertProduct"
										method="post">
										...
										<div class="form-group">
											...
											<form:hidden path="image" value="default.jpg" />
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<label>Gía</label>
											<%-- 								<form:input class="form-control" path="price" min="0"
										...
										<div>
											<form:button class="btn btn-primary" type="submit"
												onclick="return confirm('Bạn có chắc thêm sản phẩm này ?')"> Thêm sản phẩm
