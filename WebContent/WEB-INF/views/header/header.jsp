...
<body>
	...
	<div class="header">
		...
		<div class="header_top">
			<div class="logo">
				<a href="index/1/1.htm"><img src="images/logo.png" alt="" /></a>
			</div>
			<div class="">

				<div class="search_box">
					<form action="product/list-by-keywords.htm" method="post" >
						<input type="text" name="keywords" class="form-control" placeholder="Tìm kiếm sản phẩm">
					</form>
				</div>
						...
						<c:when test="${userLogin == null}">
							<div>
								<a href="login.htm" role="button"><span class="btn"><i
										class="fas fa-sign-in-alt"></i> Đăng nhập</span></a> <a href="signup.htm"
									role="button"><span class="btn"><i
							...
							<li class="dropdown"><span class="btn"><img
								...
								<div class="dropdown-menu dropdown-menu-right text-center"
									...
									<c:if test="${userLogin.roleid == 1 }">
										...
										<a href="admins/index.htm"><span class="btn"
											style="padding: 0px 0px 0px 0px;">Quản lí WEB (ADMIN)
									...
									<a href="editPassword/${userLogin.id}.htm"><span
										class="btn" style="padding: 0px 0px 0px 0px;">Đổi mật
											khẩu<i class="fas fa-file-invoice"></i>
									</span></a>

									<div class="dropdown-divider"></div>
									<a href="signout.htm"><span class="btn"
										onclick="return confirm('Bạn có chắc chắn đăng xuất ?')"
										...
										<c:choose>
											<c:when test="${totalItem == 0}">
												<div class="text-center" style="margin: 20px;">
													<span style="font-size: large;">Chưa có sản phẩm!</span>
												</div>
											</c:when>
											<c:otherwise>
												<li
												...
												<li
													style="display: block; text-align: center !important; margin: 0px;"><span><strong>Tổng:
													</strong> <fmt:formatNumber value="${totalPrice}" type="number"
															pattern="###,###" /> VNĐ</span></li>
												<hr>
												<li
					...
					<li><a href="category/1/1.htm">Bể cá mini</a>
						<ul class="sub-menu list-unstyled sub-menu2">
							<div class="navg-drop-main">
								<div class="nav-drop nav-top-brand"></div>
						</ul></li>
